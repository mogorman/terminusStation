...
require.register("js/flapdisplay.js", function(exports, require, module) {
'use strict';

var FlapBuffer = function FlapBuffer(wrap, num_lines) {
    this.wrap = wrap;
...
FlapBuffer.prototype = {
    ...
    pushWord: function pushWord(word) {
...
var FlapDisplay = function FlapDisplay(display_selector, input_selector, click_selector) {
    var _this = this;

    var onAnimStart = function onAnimStart(e) {
        var $display = $(e.target);
        $display.prevUntil('.flapper', '.activity').addClass('active');
    };

    var onAnimEnd = function onAnimEnd(e) {
        var $display = $(e.target);
...
FlapDisplay.prototype = {
    ...
    parseInput: function parseInput(text) {
    ...
    updateDisplay: function updateDisplay(buffers) {
        var _this = this;
        var timeout = 100;
...
require.register("js/jquery.flapper.js", function(exports, require, module) {
'use strict';
