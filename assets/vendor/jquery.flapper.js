(function($) {
    ...
    FlapDigit.prototype = {
        ...
        increment: function(speed, skipchars) {
            var next = this.pos + skipchars;
		...
		let skipchars = 1;
		// if difference is big go fast
		//if (pos - _this.pos > 5 || pos -_this.pos < -5)
		//{
		//    skipchars = 5;
		//}
                if (_this.pos == pos) {
                    ...
                    _this.increment(duration, skipchars);
